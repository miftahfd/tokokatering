...
@section('content')
  <div class="container px-6 mx-auto grid">
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Permission Management</h2>
    <a href="{{route('permission.create')}}" class="btn btn-sm w-1/5 md:w-1/12 text-white capitalize bg-gray-800 hover:bg-gray-950">Create</a>
    <div class="card mt-3 overflow-auto w-full bg-base-100 shadow-xl">
      <div class="card-body">
        <table id="datatable-permission" class="w-full py-4 rounded-lg stripe hover">
          <thead>
            <tr
              ...
              <tr>
                ...
                <td class="px-4 py-3 text-center text-sm">
                  <select class="datatable-select-action rounded-lg text-xs">
                    ...
                    <option value="Edit" data-url="{{route('permission.edit', $permission)}}">Edit</option>
                  </select>
                </td>
              </tr>
              @php $no++ @endphp
...
<script type="module">
  $(function() {
    ...
    $('#datatable-permission').find('.datatable-select-action').change(function() {
      let value = $(this).val()
